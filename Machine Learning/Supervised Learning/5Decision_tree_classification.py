# Random Forest is an ensemble learning. That means it uses multiple weak learners to
# produce a strong learner with high accuracy. It samples the data into multiple fragments and then
# forms Decision Trees for each and predicts the output that will be the average or most occured
# output from all decision tree
...
# Note that Feature Scaling is not compulsory task in decision Tree Algorithm
